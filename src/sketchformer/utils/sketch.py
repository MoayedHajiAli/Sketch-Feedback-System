...
def to_normal_strokes(big_stroke):
    """Convert from sketch_object.Stroke-5 format (from sketch-rnn paper) back to stroke-3."""
    l = 0
...
def to_big_strokes(stroke, max_len=250):
    """Converts from sketch_object.Stroke-3 to stroke-5 format and pads to given length."""
