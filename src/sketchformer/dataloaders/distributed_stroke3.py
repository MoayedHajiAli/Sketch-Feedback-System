...
from sketchformer.core.data import BaseDataLoader, DatasetSplit
...
class DistributedStroke3DataLoader(BaseDataLoader):
    ...
    def default_hparams(cls):
        hps = utils.hparams.HParams(
            ...
            tokenizer_dict_file= path.join(path.abspath(path.join(__file__ ,"../../..")), 'sketchformer/prep_data/sketch_token/token_dict.pkl'),
