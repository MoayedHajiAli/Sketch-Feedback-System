...
%
  ...
  p2(1:dim_num) = [ 5.0, 3.0 ];

  angle_deg = 75.0;
  r = 3.0;
  p1(1) = p2(1) + r * cos_deg ( angle_deg );
  p1(2) = p2(2) + r * sin_deg ( angle_deg );

  angle_deg = 15.0;
  r = 2.0;
  p3(1) = p2(1) + r * cos_deg ( angle_deg );
  p3(2) = p2(2) + r * sin_deg ( angle_deg );
  ...
  angle_deg = 45.0;
  r = 1.0;
  p4(1) = p2(1) + r * cos_deg ( angle_deg );
  p4(2) = p2(2) + r * sin_deg ( angle_deg );
