...
%  Parameters:
%
%    Input, real P1(3), P2(3), two points on the first line.
%
%    Input, real Q1(3), Q2(3), two points on the second line.
%
%    Output, logical VALUE is TRUE if the lines are parallel.
%
  dim_num = 3;

  pdotq = ( p2(1:dim_num) - p1(1:dim_num) ) * ...
          ( q2(1:dim_num) - q1(1:dim_num) )';

  pdotp = ( p2(1:dim_num) - p1(1:dim_num) ) * ...
          ( p2(1:dim_num) - p1(1:dim_num) )';

  qdotq = ( q2(1:dim_num) - q1(1:dim_num) ) * ...
          ( q2(1:dim_num) - q1(1:dim_num) )';
