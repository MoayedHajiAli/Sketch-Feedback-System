...
%  Parameters:
%
%    Input, real P1(2), P2(2), two points on the circle.
%
...
%
  pc(1,1) = 0.5 * ( p2(1) + p1(1) ) + h * ( p2(2) - p1(2) ) / dist;
  pc(2,1) = 0.5 * ( p2(2) + p1(2) ) - h * ( p2(1) - p1(1) ) / dist;

  pc(1,2) = 0.5 * ( p2(1) + p1(1) ) - h * ( p2(2) - p1(2) ) / dist;
  pc(2,2) = 0.5 * ( p2(2) + p1(2) ) + h * ( p2(1) - p1(1) ) / dist;
