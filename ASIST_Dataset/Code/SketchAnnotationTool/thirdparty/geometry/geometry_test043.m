...
%  Distance is 5.
%
  p1(1:dim_num) = [  2.0, 3.0, 0.0 ];
  p2(1:dim_num) = [  8.0, 6.0, 0.0 ];
  q1(1:dim_num) = [ 11.0, 6.0, 4.0 ];
  q2(1:dim_num) = [ 17.0, 9.0, 4.0 ];
...
%  Distance is 0.
%
  p1(1:dim_num) = [  1.0,  2.0,  3.0 ];
  p2(1:dim_num) = [  4.0, -1.0,  9.0 ];
  q1(1:dim_num) = [  3.0,  0.0,  7.0 ];
  q2(1:dim_num) = [  6.0, -3.0, 13.0 ];
...
%  Distance = 3.
%
  p1(1:dim_num) = [  3.0,  4.0,  5.0 ];
  p2(1:dim_num) = [  7.0,  8.0,  7.0 ];
  q1(1:dim_num) = [  9.0, 10.0,  8.0 ];
  q2(1:dim_num) = [ 13.0, 14.0, 10.0 ];
...
%  Distance is 0.
%
  p1(1:dim_num) = [  1.0,  1.0,  1.0 ];
  p2(1:dim_num) = [  1.0,  4.0,  7.0 ];
  q1(1:dim_num) = [  0.0,  2.0,  3.0 ];
  q2(1:dim_num) = [  5.0,  2.0,  3.0 ];
...
%  Distance is 3.
%
  p1(1:dim_num) = [  2.0,  2.0,  1.0 ];
  p2(1:dim_num) = [  2.0,  7.0,  11.0 ];
  q1(1:dim_num) = [  0.0,  0.0,  0.0 ];
  q2(1:dim_num) = [ -5.0, -5.0, -5.0 ];
...
%
  p1(1:dim_num) = [  1.0,  1.0,  1.0 ];
  p2(1:dim_num) = [  1.0,  6.0, 11.0 ];
  q1(1:dim_num) = [  0.0,  4.0,  7.0 ];
  q2(1:dim_num) = [ -5.0,  4.0,  7.0 ];
...
%  Distance = 10.
%
  p1(1:dim_num) = [  0.0,  5.0, 10.0 ];
  p2(1:dim_num) = [  5.0,  0.0, 10.0 ];
  q1(1:dim_num) = [  0.0,  0.0,  0.0 ];
  q2(1:dim_num) = [  6.0,  6.0,  0.0 ];
...
%  Distance = 4.
%
  p1(1:dim_num) = [ -2.0,  0.0,  0.0 ];
  p2(1:dim_num) = [ 10.0,  0.0,  0.0 ];
  q1(1:dim_num) = [ -2.0,  8.0,  1.0 ];
  q2(1:dim_num) = [  7.0,  4.0,  0.0 ];
