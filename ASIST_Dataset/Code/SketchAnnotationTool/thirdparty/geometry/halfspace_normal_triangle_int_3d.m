...
%
%    Input, real P(3), a point on the bounding plane
%    that defines the halfspace.
%
%    Input, real NORMAL(3), the components of the normal vector
...
%
  d = - normal(1:dim_num) * p(1:dim_num)';
%
%  Compute the signed distances between the vertices and the plane.
%
  dist1 = d + normal(1:dim_num) * t(1:dim_num,1);
  dist2 = d + normal(1:dim_num) * t(1:dim_num,2);
  dist3 = d + normal(1:dim_num) * t(1:dim_num,3);
%
