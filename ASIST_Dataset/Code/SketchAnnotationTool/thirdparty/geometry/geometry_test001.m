...
%
  for j = 1 : ntest
    ...
    if ( j == 1 )
      ...
      p1(1:dim_num) = [ 1.0, 0.0 ];
      p2(1:dim_num) = [ 0.0, 0.0 ];
    ...
    elseif ( j == 2 )
      ...
      p1(1:dim_num) = [ 1.0, 0.0 ];
      p2(1:dim_num) = [ 0.0, 0.0 ];
      p3(1:dim_num) = [ 0.0, 1.0 ];

    elseif ( j == 3 )

      p1(1:dim_num) = [ 1.0, -1.0 ];
      p2(1:dim_num) = [ 0.0,  0.0 ];
      p3(1:dim_num) = [ 0.0,  1.0 ];
    ...
    elseif ( j == 6 )
      ...
      p1(1:dim_num) = [ 1.0,  0.0 ];
      p2(1:dim_num) = [ 0.0,  0.0 ];
      p3(1:dim_num) = [ 1.0, -0.01 ];

    end
 
    r8vec_print ( dim_num, p1, '  Vertex P1' )
    r8vec_print ( dim_num, p2, '  Vertex P2' )
    r8vec_print ( dim_num, p3, '  Vertex P3' )
