...
%    the triangle.
%
%    Input, real P0(3), PD(3), parameters that define the
%    parametric line.
%
%    Output, logical INSIDE, is TRUE if (the intersection point of)
%    the line is inside the triangle.
%
%    Output, real P(3), is the point of intersection of the line
...
%
    ...
    angle_sum = arc_cosine ( v1(1:3) * v2(1:3)' ) ...
              + arc_cosine ( v2(1:3) * v3(1:3)' ) ...
              + arc_cosine ( v3(1:3) * v1(1:3)' );
