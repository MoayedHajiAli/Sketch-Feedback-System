function geometry_test1839 ( )

%*****************************************************************************80
%
%% TEST1839 tests SPHERE_IMP_GRIDPOINTS_ICOS2.
%
%  Licensing:
%
...
%
  ...
  fprintf ( 1, '  SPHERE_IMP_GRIDPOINTS_ICOS2 creates the grid.\n' );
  ...
  node_xyz = sphere_imp_gridpoints_icos2 ( factor, node_num );
