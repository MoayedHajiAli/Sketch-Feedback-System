...
%
    if ( itest == 1 )
      ...
      p1(1:dim_num) = [ 0.0,  2.0 ];
      p2(1:dim_num) = [ 4.0,  0.0 ];
      q1(1:dim_num) = [ 0.0, -1.0 ];
      q2(1:dim_num) = [ 1.0,  0.0 ];
%
%  x + 2y - 4 = 0
%  2x + 4y - 1 = 0
%
    elseif ( itest == 2 )
      ...
      p1(1:dim_num) = [ 0.00, 2.00 ];
      p2(1:dim_num) = [ 4.00, 0.00 ];
      q1(1:dim_num) = [ 0.00, 0.25 ];
      q2(1:dim_num) = [ 0.50, 0.00 ];
%
%  x + 2y - 4 = 0
%  -3x - 6y +12 = 0
%
    elseif ( itest == 3 )
      ...
      p1(1:dim_num) = [ 0.0, 2.0 ];
      p2(1:dim_num) = [ 4.0, 0.0 ];
      q1(1:dim_num) = [ 0.0, 2.0 ];
      q2(1:dim_num) = [ 4.0, 0.0 ];
