...
%
  ...
  for i = 0 : n_test
    ...
    centroid1(1:2) = circle_lune_centroid_2d ( r, center, theta1, theta2 );

    centroid2(1:2) = circle_sector_centroid_2d ( r, center, theta1, theta2 );

    fprintf ( 1, '  %12f  %12f  %12f  %12f  %12f\n', ...
      theta2, centroid1(1:2), centroid2(1:2) );
